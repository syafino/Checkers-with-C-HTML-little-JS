...
function submitMove(event) {
    ...
    .then(data => {
        ...
        const currentTurn = htmlDoc.getElementById('turnIndicator'); // Ensure this is correctly selected
        
        if (!newBoard || !newBoardState || !currentTurn) {
        ...
        // Update the turn indicator based on the received HTML content
        document.getElementById('turnIndicator').innerHTML = currentTurn.innerHTML;
...
// Function to update the turn indicator (optional, but for clarity)
